...
plant zarith-direct purity 'reaches "zarith"' \
  "sed -i 's/(libraries fmt)/(libraries fmt zarith)/' lib/foundation/dune"
...
plant zarith-transitive purity 'reaches "zarith"' "
  ...
  sed -i 's/(libraries fmt)/(libraries fmt relay)/' lib/foundation/dune"
...
plant unix-edge purity 'reaches "unix"' \
  "sed -i 's/(libraries fmt)/(libraries fmt unix)/' lib/foundation/dune"
...
plant js-runtime-stub purity 'ships a foreign object' "
  ...
  sed -i 's/(libraries fmt)/(libraries fmt fastpath)/' lib/foundation/dune"
...
plant ppx-in-production purity 'reaches "ppx_expect"' \
  "sed -i 's/(libraries fmt)/(libraries fmt ppx_expect)/' lib/foundation/dune"
...
plant test-in-production purity 'non-production library' "
  ...
  sed -i 's/(libraries fmt)/(libraries fmt helper)/' lib/foundation/dune"
...
plant generic-to-target layers 'depends on target' "
  ...
  sed -i 's/(libraries fmt)/(libraries fmt aarch64_target)/' lib/foundation/dune"
