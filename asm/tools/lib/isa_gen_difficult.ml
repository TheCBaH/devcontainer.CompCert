...
let all =
  ...
  @ czero_eqz_entries @ czero_nez_entries @ xperm4_entries @ xperm8_entries @ sha256sum0_entries
  ...
  @ aes32esi_entries @ aes32esmi_entries @ csrrw_entries @ csrrs_entries @ csrrc_entries
  @ csrrwi_entries @ csrrsi_entries @ csrrci_entries @ csrr_entries @ csrw_entries @ csrs_entries
  @ csrc_entries @ csrwi_entries @ csrsi_entries @ csrci_entries @ amoswap_w_entries
