...
let test_counts () =
  ...
  check "all includes every difficult-form family"
    ...
    = List.length Isa_gen_difficult.sw_entries
      ...
      + List.length Isa_gen_difficult.x86_alu_rr_entries
      + List.length Isa_gen_difficult.x86_alu_memv_entries
      + List.length Isa_gen_difficult.x86_alu_memv_gprv_entries
      + List.length Isa_gen_difficult.x86_alu_immz_entries
      + List.length Isa_gen_difficult.x86_alu_immb_entries
      + List.length Isa_gen_difficult.x86_alu_memv_immb_entries
      + List.length Isa_gen_difficult.x86_alu_memv_immz_entries
      + List.length Isa_gen_difficult.x86_alu_gpr8_immb_entries
      + List.length Isa_gen_difficult.x86_alu_memb_immb_entries
      ...
      + List.length Isa_gen_difficult.x86_cvtf2i_rr_entries
      + List.length Isa_gen_difficult.x86_cvtf2i_rm_entries
      + List.length Isa_gen_difficult.x86_movd_load_rr_entries
      ...
      + List.length Isa_gen_difficult.x86_pextrw_rr_entries
      + List.length Isa_gen_difficult.x86_vpinsrw_rrr_entries
      + List.length Isa_gen_difficult.x86_vpinsrw_rr_mem_entries
      + List.length Isa_gen_difficult.x86_vpextrw_rr_entries
  ...
  check "x86_vex_binop_rrr_entries has 140 entries (70 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_binop_rrr_entries = 140);
  check "x86_vex_binop_rr_mem_entries has 140 entries (70 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_binop_rr_mem_entries = 140);
  check "x86_vex_unop_rr_entries has 28 entries (14 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_unop_rr_entries = 28);
  check "x86_vex_unop_rr_mem_entries has 26 entries (13 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_unop_rr_mem_entries = 26);
  check "x86_sse_binop_imm_rr_entries has 18 entries (9 mnemonics, one per target)"
