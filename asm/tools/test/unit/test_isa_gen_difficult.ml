...
let test_counts () =
  ...
  check "x86_vex_binop_rrr_entries has 68 entries (34 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_binop_rrr_entries = 68);
  check "x86_vex_binop_rr_mem_entries has 68 entries (34 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_binop_rr_mem_entries = 68);
  check "x86_vex_unop_rr_entries has 20 entries (10 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_unop_rr_entries = 20);
  check "x86_vex_unop_rr_mem_entries has 20 entries (10 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_unop_rr_mem_entries = 20)
