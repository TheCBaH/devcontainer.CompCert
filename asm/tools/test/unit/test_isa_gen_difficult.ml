...
let test_counts () =
  ...
  check "x86_vex_binop_rrr_entries has 76 entries (38 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_binop_rrr_entries = 76);
  check "x86_vex_binop_rr_mem_entries has 76 entries (38 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_vex_binop_rr_mem_entries = 76);
