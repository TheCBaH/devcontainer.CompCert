...
let test_counts () =
  ...
  check "x86_sse_binop_imm_rr_entries has 40 entries (20 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_sse_binop_imm_rr_entries = 40);
  check "x86_sse_binop_imm_rm_entries has 40 entries (20 mnemonics, one per target)"
    (List.length Isa_gen_difficult.x86_sse_binop_imm_rm_entries = 40);
