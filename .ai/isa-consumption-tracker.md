...
| GEN-05-X86-INT | Legacy integer, string, BMI/LZCNT/POPCNT/ADX/MOVBE, CMOV | implementing | INF-05X | Integer rows landed (GPRv 16/32/64, implicit %cl/accumulator, opcode-embedded registers); next: CMOVcc/SETcc spelling, string ops, mixed-width moves, DF64/FORCE64 stack forms, LOCK/REP prefixes |
