...
| GEN-05-X86-APX | REX2, r16–r31, map-4, NDD, NF, CCMP/CTEST | implementing | GEN-05-X86-INT, EVEX machinery | Map-4 promotions landed (ND, NF, {evex}); next: CCMP/CTEST (SCC, {dfv=}), shift-by-one forms, REX2 and r16-r31 |
