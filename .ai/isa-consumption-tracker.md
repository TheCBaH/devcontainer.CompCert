...
Baseline: `b659f3e`, reviewed 2026-09-05.
...
|---|---|---|
| S0 Baseline | done | Plan sections 2–3 and 7: measured exports, 47 producer tests, four-profile inventory check, GAS compressed-width probe |
| S1 Capture fidelity | not-started | CAP-01: fix and verify C/Zc width inference; define native capture contract |
...
- [ ] CAP-01 Correct the measured 31 RV32 / 29 RV64 compressed-width labels;
  establish encoding invariants and independent GAS examples.
...
- [ ] CAP-05 Add negative validation controls and fresh-process regeneration
  evidence; preserve or explain compatibility manifest differences.

Exit: S1 gates pass and NORM has versioned input fixtures plus a documented
loss/unknown report. Evidence must include the width counterexample.
...
- [ ] GAS-01 Freeze case/artifact/verdict schema and proposed CLI/Make targets.
...
Owner: unassigned. Stage: S5. Prerequisite: GAS/GEN evidence for extracted forms.
